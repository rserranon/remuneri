...
<html>
    ...
    <body>
        ...
        <div id="show-anuncio" class="content scaffold-show" role="main">
            ...
            <f:display bean="anuncio" />
            <g:form resource="${this.anuncio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.anuncio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
