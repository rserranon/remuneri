...
<html>
    ...
    <body>
        ...
        <div id="show-contenido" class="content scaffold-show" role="main">
            ...
            <f:display bean="contenido" />
            <g:form resource="${this.contenido}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.contenido}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
