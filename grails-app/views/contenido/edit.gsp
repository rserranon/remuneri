...
<html>
    ...
    <body>
        ...
        <div id="edit-contenido" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.contenido}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.contenido}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.contenido}" method="PUT">
                <g:hiddenField name="version" value="${this.contenido?.version}" />
                <fieldset class="form">
                    <f:all bean="contenido"/>
                </fieldset>
